...
/**
 * _ptintstr - print string element from va_list
 * @list: va_list passed to funvtion
 */

void _ptintstr(va_list list)
{
	char *s;
...
/**
 * _printint - print all type element from va_list
 * @list: va_list passed to function
 */
 ...
 * @format: string to use and print
 */
